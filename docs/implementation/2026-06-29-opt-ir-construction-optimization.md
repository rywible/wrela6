...
validatedBuffer    value,edge,packetSource               proofMirEdge, layoutFact, coreCertificate     provesInBounds, provesImpossible
...
| 14B Bounds/layout/endian/ABI query indexes                         | 14A            | `src/opt-ir/facts/bounds-facts.ts`, `src/opt-ir/facts/layout-facts.ts`, `src/opt-ir/facts/abi-facts.ts`, `tests/unit/opt-ir/fact-index.test.ts`                                    | `bun test ./tests/unit/opt-ir/fact-index.test.ts -t "layout and bounds"`                  |
