...
export const HIR_DIAGNOSTIC_CODES = [
  ...
  "HIR_ENUM_CONSTRUCTOR_ARGUMENT_MISMATCH",
...
export const HIR_DIAGNOSTIC_FIRST_EMITTER = {
  ...
  HIR_MISSING_LITERAL_TEXT: "WCR-18",
  HIR_INVALID_INTEGER_LITERAL: "WCR-18",
  HIR_MISSING_NAME_TEXT: "WCR-18",
  HIR_MISSING_OWNER_FUNCTION: "WCR-18",
  ...
  HIR_ENUM_CONSTRUCTOR_ARGUMENT_MISMATCH: "WCR-41",
